        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto pull-right">
            ...
            <cfif structKeyExists(SESSION, 'USER') >
              ...
              <li class="nav-item ">
                <a class="nav-link" href="index.cfm?event=addart"><i class="glyphicon glyphicon-pencil" aria-hidden="true" ></i>&nbsp Add New Image</a>
              </li>
<!---               <li class="nav-item ">
              ...
              <li class="nav-item ">
                <a class="nav-link" href="index.cfm?event=Profile"><i class="fa fa-user" aria-hidden="true">&nbsp <cfoutput>#SESSION.USER['NAME']#</cfoutput></i></a>
              </li>
              <li class="nav-item">
